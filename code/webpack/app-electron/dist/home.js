...
"use strict";
/* 🔥 this is hot-loader/react-dom 🔥 */ /** @license React v17.0.2
...
var existing=useFiber(current,textContent);existing["return"]=returnFiber;return existing;}}__signature__(updateTextNode,"useFiber{existing}",function(){return[useFiber];});function updateElement(returnFiber,current,element,lanes){if(current!==null){if(current.elementType===element.type||// Keep this check inline so it only runs on the false path:
hotCompareElements(current.elementType,element.type,hotUpdateChild(current),current.type)){// Move based on index
...
var existing=useFiber(current,portal.children||[]);existing["return"]=returnFiber;return existing;}}__signature__(updatePortal,"useFiber{existing}",function(){return[useFiber];});function updateFragment(returnFiber,current,fragment,lanes,key){if(current===null||current.tag!==Fragment){// Insert
...
deleteRemainingChildren(returnFiber,currentFirstChild);var created=createFiberFromText(textContent,returnFiber.mode,lanes);created["return"]=returnFiber;return created;}__signature__(reconcileSingleTextNode,"useFiber{existing}",function(){return[useFiber];});function reconcileSingleElement(returnFiber,currentFirstChild,element,lanes){var key=element.key;var child=currentFirstChild;while(child!==null){// TODO: If key === null and child.key === null, then this only applies to
...
hotCompareElements(child.elementType,element.type,hotUpdateChild(child),child.type)){deleteRemainingChildren(returnFiber,child.sibling);var _existing3=useFiber(child,element.props);_existing3.ref=coerceRef(returnFiber,child,element);_existing3["return"]=returnFiber;{_existing3._debugSource=element._source;_existing3._debugOwner=element._owner;}return _existing3;}break;}}// Didn't match.
deleteRemainingChildren(returnFiber,child);break;}else{deleteChild(returnFiber,child);}child=child.sibling;}if(element.type===REACT_FRAGMENT_TYPE){var created=createFiberFromFragment(element.props.children,returnFiber.mode,lanes,element.key);created["return"]=returnFiber;return created;}else{var _created4=createFiberFromElement(element,returnFiber.mode,lanes);_created4.ref=coerceRef(returnFiber,currentFirstChild,element);_created4["return"]=returnFiber;return _created4;}}__signature__(reconcileSingleElement,"useFiber{existing}\nuseFiber{_existing3}",function(){return[useFiber,useFiber];});function reconcileSinglePortal(returnFiber,currentFirstChild,portal,lanes){var key=portal.key;var child=currentFirstChild;while(child!==null){// TODO: If key === null and child.key === null, then this only applies to
// the first item in the list.
...
__signature__(reconcileSinglePortal,"useFiber{existing}",function(){return[useFiber];});function reconcileChildFibers(returnFiber,currentFirstChild,newChild,lanes){// This function is not recursive.
...
var newQueue={pending:null,dispatch:null,lastRenderedReducer:basicStateReducer,lastRenderedState:snapshot};newQueue.dispatch=setSnapshot=dispatchAction.bind(null,currentlyRenderingFiber$1,newQueue);stateHook.queue=newQueue;stateHook.baseQueue=null;snapshot=readFromUnsubcribedMutableSource(root,source,getSnapshot);stateHook.memoizedState=stateHook.baseState=snapshot;}return snapshot;}__signature__(useMutableSource,"useState{_dispatcher$useState(function () {\n    return readFromUnsubcribedMutableSource(root, source, getSnapshot);\n  })}\nuseEffect{}\nuseEffect{}");function mountMutableSource(source,getSnapshot,subscribe){var hook=mountWorkInProgressHook();hook.memoizedState={refs:{getSnapshot:getSnapshot,setSnapshot:null},source:source,subscribe:subscribe};return useMutableSource(hook,source,getSnapshot,subscribe);}__signature__(mountMutableSource,"useMutableSource{}",function(){return[useMutableSource];});function updateMutableSource(source,getSnapshot,subscribe){var hook=updateWorkInProgressHook();return useMutableSource(hook,source,getSnapshot,subscribe);}__signature__(updateMutableSource,"useMutableSource{}",function(){return[useMutableSource];});function mountState(initialState){var hook=mountWorkInProgressHook();if(typeof initialState==='function'){// $FlowFixMe: Flow doesn't like mixed types
...
key,pendingProps,owner,mode,lanes){type=hotResolveType(type);var fiberTag=IndeterminateComponent;// The resolved type is set if we know what the final type will be. I.e. it's not lazy.
...
console.info('%cDownload the React DevTools '+'for a better development experience: '+'https://reactjs.org/link/react-devtools'+(protocol==='file:'?'\nYou might need to use a local HTTP server (instead of file://): '+'https://reactjs.org/link/react-devtools-faq':''),'font-weight:bold');}}}}var hotUpdateChild=function hotUpdateChild(child){return function(newType){child.type=newType;if(child.alternate){child.alternate.type=newType;}};};var hotResolveType=function hotResolveType(type){return type;};var hotCompareElements=function hotCompareElements(oldType,newType){return oldType===newType;};var hotCleanupHooks=function hotCleanupHooks(){if(typeof resetHooks!=='undefined'){resetHooks();}};var evalInReactContext=function evalInReactContext(injection){return eval(injection);};var hotCleanup=hotCleanupHooks;var hotRenderWithHooks=function hotRenderWithHooks(current,render){hotCleanupHooks();if(typeof nextCurrentHook!=='undefined'&&typeof ReactCurrentDispatcher$1!=='undefined'){nextCurrentHook=current!==null?current.memoizedState:null;if(typeof firstCurrentHook!=='undefined'){firstCurrentHook=nextCurrentHook;}ReactCurrentDispatcher$1.current=nextCurrentHook===null?HooksDispatcherOnMountInDEV:HooksDispatcherOnUpdateInDEV;}var rendered=render();hotCleanupHooks();return rendered;};var setHotElementComparator=function setHotElementComparator(newComparator){hotCompareElements=newComparator;};var setHotTypeResolver=function setHotTypeResolver(newResolver){hotResolveType=newResolver;};;exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Internals;exports.evalInReactContext=evalInReactContext,exports.hotCleanup=hotCleanup,exports.hotRenderWithHooks=hotRenderWithHooks,exports.setHotElementComparator=setHotElementComparator,exports.setHotTypeResolver=setHotTypeResolver,exports.createPortal=createPortal$1;exports.findDOMNode=findDOMNode;exports.flushSync=flushSync;exports.hydrate=hydrate;exports.render=render;exports.unmountComponentAtNode=unmountComponentAtNode;exports.unstable_batchedUpdates=batchedUpdates$1;exports.unstable_createPortal=unstable_createPortal;exports.unstable_renderSubtreeIntoContainer=renderSubtreeIntoContainer;exports.version=ReactVersion;})();}/* 🔥 this is hot-loader/react-dom 🔥 */
...
(function () {
  ...
  reactHotLoader.register(checkDCE, "checkDCE", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/node_modules/@hot-loader/react-dom/index.js");
})();
...
(function () {
  ...
  reactHotLoader.register(getOwnPropertySymbols, "getOwnPropertySymbols", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/node_modules/object-assign/index.js");
  reactHotLoader.register(hasOwnProperty, "hasOwnProperty", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/node_modules/object-assign/index.js");
  reactHotLoader.register(propIsEnumerable, "propIsEnumerable", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/node_modules/object-assign/index.js");
  reactHotLoader.register(toObject, "toObject", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/node_modules/object-assign/index.js");
  reactHotLoader.register(shouldUseNative, "shouldUseNative", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/node_modules/object-assign/index.js");
})();
...
function App() {
  var handleClick = function handleClick() {
    electron__WEBPACK_IMPORTED_MODULE_1__.ipcRenderer.send("win:click");
  };

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "This is our React fecde!"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
    onClick: handleClick
  }, "click"));
}
...
(function () {
  ...
  reactHotLoader.register(App, "App", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/src/pages/home/App.js");
  reactHotLoader.register(_default, "default", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/src/pages/home/App.js");
})();
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default().render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, "Hello, world!"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_App__WEBPACK_IMPORTED_MODULE_2__["default"], null)), root);
...
(function () {
  ...
  reactHotLoader.register(root, "root", "/Users/fangzhiqing/Desktop/fangdown/github/app-blog/code/webpack/app-electron/src/pages/home/index.js");
})();
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/pages/home/index.js");
/******/ 	
/******/ })()
;